...
const FeatureCard = ({ title, subtitle, description, number, images }) => {
  ...
  //   if (number === "00") {
  //     var temp = importAll(
  //       require.context("../assets/images/00", false, /\.(png|jpeg|svg|mp4)$/)
  //     );
  //     setImages(temp);
  ...
  //   } else if (number === "01") {
  //     var temp = importAll(
  //       require.context("../assets/images/01", false, /\.(png|jpeg|svg|mp4)$/)
  //     );
  //     setImages(temp);
  ...
  //   } else if (number === "02") {
  //     var temp = importAll(
  //       require.context("../assets/images/02", false, /\.(png|jpeg|svg|mp4)$/)
  //     );
  //     setImages(temp);
  ...
  //   } else if (number === "03") {
  //     var temp = importAll(
  //       require.context("../assets/images/03", false, /\.(png|jpeg|svg|mp4)$/)
  //     );
  //     setImages(temp);
  ...
  //   } else if (number === "04") {
  //     var temp = importAll(
  //       require.context("../assets/images/04", false, /\.(png|jpeg|svg|mp4)$/)
  //     );
  //     setImages(temp);
  ...
  //   } else if (number === "05") {
  //     var temp = importAll(
  //       require.context("../assets/images/05", false, /\.(png|jpeg|svg|mp4)$/)
  //     );
  //     setImages(temp);
  ...
  //   } else if (number === "06") {
  //     var temp = importAll(
  //       require.context("../assets/images/06", false, /\.(png|jpeg|svg|mp4)$/)
  //     );
  //     setImages(temp);
  ...
  //   } else if (number === "07") {
  //     var temp = importAll(
  //       require.context("../assets/images/07", false, /\.(png|jpeg|svg|mp4)$/)
  //     );
  //     setImages(temp);
  ...
  //   } else if (number === "08") {
  //     var temp = importAll(
  //       require.context("../assets/images/08", false, /\.(png|jpeg|svg|mp4)$/)
  //     );
  //     setImages(temp);
  ...
  //   } else if (number === "09") {
  //     var temp = importAll(
  //       require.context("../assets/images/09", false, /\.(png|jpeg|svg|mp4)$/)
  //     );
  //     setImages(temp);
  //     var tempFile = require("../assets/files/09.pdf");
  //     setFile(tempFile);
  //   } else if (number === "10") {
  //     var temp = importAll(
  //       require.context("../assets/images/10", false, /\.(png|jpeg|svg|mp4)$/)
  //     );
  //     setImages(temp);
  ...
  const renderMedia = () => {
    ...
    if (
      ...
      currentImage.endsWith(".jpg") ||
      currentImage.endsWith(".jpeg")
    ) {
