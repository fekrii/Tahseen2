...
const data = [
...

  {
    ...
    description: `
    أحد مشاريع مبادرة "تحسين" للمجتمعات الجديدة وهو مبنى "تمرة" ذاتي السداد، ويضم ٢٥ وحدة سكنية محاطة بمزرعة نخيل على مساحة ١٠٠ فدان، ويتميز بتشغيل الوحدات والمزرعة بالطاقة الشمسية، مع التركيز على الاستدامة والطاقة النظيفة. 
      `,
    images: images04,
  },
